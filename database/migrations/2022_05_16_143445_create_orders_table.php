...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            // ANS : Using float can round off numbers and change the value slightly. Instead, use of decimal(2,2) to keep the number exact and correct.
            $table->float('subtotal');
            // $table->float('commission_owed')->default(0.00);

            $table->decimal('commission_owed', 6, 2)->default(0.00); // assuming max 99.99 commission rate
